                  ...
                  <form onSubmit={form.handleSubmit(handleLoginSubmit)} className="space-y-8">
                    ...
                    <div className='text-center'>
                      <div className='flex items-center gap-1.5'>
                        ...
                        <Link href={WEBSITE_REGISTER} className='text-primary hover:underline'>Create account!</Link>
                      </div>
                      <div className='mt-3'>
                        <Link href={WEBSITE_RESETPASSWORD} className='text-primary hover:underline'>Forgot Password?</Link>
                      </div>
                    </div>
                  </form>
                </Form>
