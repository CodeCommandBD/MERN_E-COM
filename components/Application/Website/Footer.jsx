...
const Footer = () => {
  return (
    <div>
      <footer className="bg-gray-100 text-gray-600 py-4 px-4 lg:py-12 lg:px-32 border-t border-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div>
            <h2 className="text-xl font-bold mb-5 uppercase">Userfull Links</h2>
            <ul className="text-gray-600 space-y-2">
              <li>
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-5">
              <Link href={""}><AiOutlineYoutube size={25} className="text-xl text-gray-600 hover:text-primary transition-all duration-300" /></Link>
              <Link href={""}><FaInstagram size={25} className="text-xl text-gray-600 hover:text-primary transition-all duration-300" /></Link>
              <Link href={""}><FaWhatsapp size={25} className="text-xl text-gray-600 hover:text-primary transition-all duration-300" /></Link>
              <Link href={""}><TiSocialFacebook size={25} className="text-xl text-gray-600 hover:text-primary transition-all duration-300" /></Link>
              <Link href={""}><FiTwitter size={25} className="text-xl text-gray-600 hover:text-primary transition-all duration-300" /></Link>
            </div>
          </div>
        </div>
      </footer>
