...
import { MaterialReactTable, useMaterialReactTable, MRT_ToggleGlobalFilterButton, MRT_ShowHideColumnsButton, MRT_ToggleFullScreenButton, MRT_ToggleDensePaddingButton } from 'material-react-table';
      ...
      <>
        ...
        {deleteType !== 'SD'
          ...
          <Tooltip title={'Delete All'}>
            <IconButton disabled={!table.getIsSomeRowsSelected()}
              onClick={() => handleDelete(Object.keys(selectedRows), deleteType)}
            >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, width: '100%' }}>
        {exportEndpoint && (
          <Tooltip arrow title="Export Data">
            <ButtonLoading 
              type='button'
              text={<div className='semi-bold cursor-pointer'>Export <FileDownloadIcon /></div>}
        ...
        <div style={{ marginLeft: 'auto' }}>
          {table.getIsAllRowsSelected() && deleteType !== 'SD' && (
            <Tooltip title={'Delete All'}>
              <IconButton onClick={() => handleDelete(Object.keys(selectedRows), deleteType)}>
                <DeleteIcon />
              </IconButton>
            </Tooltip>
          )}
